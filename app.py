...
class User(db.Model):
    ...
    def __repr__(self):
        return f"name:{self.name},sample_id:{self.sample_id},state:{self.state},nation:{self.nation},date_of_test:{self.date_of_test},date_of_sample:{self.date_of_sample}," \
